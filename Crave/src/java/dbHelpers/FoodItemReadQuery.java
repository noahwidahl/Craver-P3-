...
public class FoodItemReadQuery {
    ...
    public FoodItemReadQuery(Integer supplierId) {
        ...
        try {
            ...
            Logger.getLogger(FoodItemReadQuery.class.getName()).log(Level.SEVERE, null, ex);
        }

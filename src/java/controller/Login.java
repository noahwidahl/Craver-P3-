...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //If-statement to handle which usertype is loggin in
        if("user".equals(loginType)){
            ...
            //if-statement to handle if the login was successfull or not
            if (isValidUser) { 
                //Logged in with success, setting user information in the session
                ...
                //Logged in with success, setting guest user information in the session
                ...
                try {
                    //Running the method setGuestLogin to log whenever a guest is entering the system
                    guest.setGuestLogin();
